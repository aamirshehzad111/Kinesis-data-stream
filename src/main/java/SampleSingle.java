...
//        }
        ...
        String streamName = "number-generator-stream";
        String region = null;
        if (args.length > 1) {
            region = args[1];
        }
    ...
    private static class SampleRecordProcessor implements ShardRecordProcessor {
        ...
        private static final String SHARD_ID_MDC_KEY = "shardId-000000000001";
...
//    static void GetRecords(String shardId){
//
...
//
//        GetShardIteratorResult getShardIteratorResult = client.getShardIterator();
//        shardIterator = getShardIteratorResult.getShardIterator();
//
//        GetRecordsResult recordsResult = new GetRecordsResult()
//                .withNextShardIterator("\"AAAAAAAAAAGxnKNBSiLpOd0Fz4bxdD2LPSjBXFYo69cqxEmpEbR+0Fx6tX0OMPQnZebTxhEFxSgkHS2YxqUatKoDqecrF2Lg+xr9zvMcuyRNMBhRRFHd1aXZl1SWSZ1pps+yewTbBmrT4BFP6YPPFClOgQZzstWXINPw2f3XxujPPnHeH6DkdfzChcmm/BurZHKDBwm7DUeb8ITYrvw3mI8+29sKU2Khy/HmfaxdakkORKZ7s+NAmg==\"\n")
//                .withRecords()
//                .withMillisBehindLatest(0L);
//
//        System.out.println(recordsResult);
//    }